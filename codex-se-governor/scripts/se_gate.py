...
REQUIRED = [
    ...
    "docs/software-engineering/COURSE_SOURCE_LOCK.json",
    ...
    "scripts/validate_source_archive.py",
    ...
    "scripts/validate_course_source_lock.py",
    ...
    "scripts/validate_pytest_environment.py",
    "scripts/scan_task_artifacts.py",
    ...
    "docs/architecture/VALIDATION_EXECUTION_GRAPH.md",
...
SKIP_DIRS = {".git", "__pycache__", ".pytest_cache", "node_modules", "dist", ".next", ".wrangler"}
