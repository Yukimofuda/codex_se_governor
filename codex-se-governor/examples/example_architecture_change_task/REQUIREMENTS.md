# Requirements: Authentication Rate-Limit Architecture Change

## Traceability ID

- Requirement set ID: LOGIN-RATE-LIMIT
- Task: Move authentication rate limiting into a dedicated policy and storage boundary to support scaling.
