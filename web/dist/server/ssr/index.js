...
var client_references_default = {
	"15c18cfaeeff": async () => {
		const m = await import("./assets/layout-segment-context-Bns3lVFq.js");
		return { get "LayoutSegmentProvider"() {
			return m["LayoutSegmentProvider"];
		} };
	},
	"593f344dc510": async () => {
		const m = await import("./assets/error-boundary-AUJy4vXa.js");
		return {
			get "ErrorBoundary"() {
	...
	"c2747888630f": async () => {
		const m = await import("./assets/link-CrtfTvqC.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"dd08de4c70e2": async () => {
		const m = await import("./assets/GovernorApp-qbSJUOVe.js");
		return { get "default"() {
			return m["default"];
		} };
	}
