globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/GovernorApp-IuLTCP28.js","assets/layout-segment-context-C49WUHXA.js","assets/link-d9tPbPvU.js","assets/router-BhPaUVga.js"];
...
function getDraftSecret() {
	return "b584896e-4d3b-4035-8e89-e773fc642161";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "0c51e6f7-bb60-45a9-b894-1a13b3dfa23e";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "0c51e6f7-bb60-45a9-b894-1a13b3dfa23e") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "0c51e6f7-bb60-45a9-b894-1a13b3dfa23e",
		rootBoundaryId
	});
}
/**
...
var GovernorApp_default = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'default' is called on server");
}, "dd08de4c70e2", "default");
//#endregion
//#region app/page.tsx
var page_exports$2 = /* @__PURE__ */ __exportAll({ default: () => Home });
function Home() {
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(GovernorApp_default, {});
}
...
var metadata = {
	title: "Codex SE Governor | Lifecycle Workspace",
	description: "Create, validate, and export traceable software engineering task packages without running repository code.",
	icons: {
		icon: "/favicon.svg",
	...
	openGraph: {
		...
		description: "A local-first software engineering lifecycle workspace.",
		type: "website"
	}
};
...
//#endregion
//#region app/api/capabilities/route.ts
...
//#endregion
//#region app/privacy/page.tsx
var page_exports$1 = /* @__PURE__ */ __exportAll({ default: () => PrivacyPage });
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(link_default, {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h1", { children: "Local-first by default" }),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "Projects, task artifacts, uploaded ZIP files, and validation results are processed in your browser. The MVP does not create an account, upload repository content, or store project data on the server." }),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: "Local storage" }),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "Projects and artifact revisions are stored in IndexedDB on the current device. Use Settings to delete them." }),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: "Uploaded files" }),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "ZIP bytes remain in browser memory for static inspection and are discarded when the page is closed or reloaded. Uploaded code is never executed." }),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: "Logs and training" }),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "The application does not send repository content to application logs or AI training services. Hosting infrastructure may retain standard request metadata that does not include locally processed files." }),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: "Exports" }),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "Generated downloads contain only the artifacts selected in the current local workspace. Review files before sharing them." }),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: "Contact" }),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "No public support identity has been configured for this MVP." })
				]
			})]
		})
	});
...
//#endregion
//#region app/terms/page.tsx
var page_exports = /* @__PURE__ */ __exportAll({ default: () => TermsPage });
function TermsPage() {
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("main", {
		className: "legal-page",
		children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(link_default, {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h1", { children: "Engineering evidence, not certification" }),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "Codex SE Governor helps create and inspect software engineering artifacts. Browser-static checks are not a security audit, legal opinion, compliance certification, or proof that a software product is correct." }),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: "Execution boundary" }),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "The public MVP does not run uploaded code, tests, package scripts, shell commands, or binaries. Do not treat NOT RUN or UNKNOWN evidence as PASS." }),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: "User responsibility" }),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("ul", { children: [
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("li", { children: "Review generated artifacts before implementation or distribution." }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("li", { children: "Do not upload content you are not authorized to inspect." }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("li", { children: "Keep secrets and personal data out of generated prompts and shared exports." }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("li", { children: "Use an isolated engineering environment for real builds and tests." })
					] }),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: "Availability" }),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "The service is provided as an early public tool and may change without preserving local browser data." })
				]
			})]
		})
	});
...
var routes = [
	...
	},
	{
		...
		ids: {
			"route": "route:/api/capabilities",
			"page": null,
			"routeHandler": "route-handler:/api/capabilities",
			"rootBoundary": "root-boundary:/",
			"layouts": ["layout:/"],
			"templates": [],
			"slots": {}
		...
		layouts: [layout_exports],
		routeSegments: ["api", "capabilities"],
		templateTreePositions: [],
		layoutTreePositions: [0],
		templates: [],
		errors: [null],
