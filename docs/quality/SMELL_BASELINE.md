...
| .agents/skills/software-engineering-governor/scripts/checklist_report.py | repeated large string appears 4 or more times | false positive | governor-maintainer | Repetition comes from common path expression in a tiny wrapper script. | 2026-07-05 | v0.8 |
