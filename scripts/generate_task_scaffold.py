...
MAP = {
    ...
    "AI_USAGE_REVIEW.md": "AI_USAGE_REVIEW_TEMPLATE.md",
    "PROCESS_COMPLIANCE_REPORT.md": "PROCESS_COMPLIANCE_REPORT.md",
    "DEPLOYMENT_PLAN.md": "DEPLOYMENT_PLAN_TEMPLATE.md",
    "MAINTENANCE_TASK.md": "MAINTENANCE_TASK_TEMPLATE.md",
