# Final Engineering Report: Authentication Rate-Limit Architecture Change
...
- R-001: Lockout abuse remains possible and requires support monitoring.
- R-002: Counter store reliability must be monitored.
- R-003: Account enumeration risk is reduced by generic messages and tests.
- R-004: Policy maintainability depends on named configuration.
